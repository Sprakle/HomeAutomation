...
public class Memo implements InterpretationModule {
	...
	private PerspectiveConverter pConverter;
	private Tagger tagger;

	public Memo(Logger logger, Tagger tagger, BehaviourManager bm, ExternalSoftware exs) {
		this.logger = logger;
		this.tagger = tagger;
		this.bm = bm;
	...
	public ExecutionResult execute(Stack<Phrase> phrases) {
		...
		String millisString = new Long(date.getTime()).toString();
