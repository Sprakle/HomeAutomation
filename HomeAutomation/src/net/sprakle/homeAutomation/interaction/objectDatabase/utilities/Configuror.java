...
class Configuror {
	static ArrayList<Component> configureDatabase(Document doc, Arduino arduino, ArrayList<Component> tree) {
		ArrayList<Component> configured = new ArrayList<Component>();
