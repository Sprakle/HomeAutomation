...
public class PlayTrack extends Command {
	...
	public PlayTrack(Logger logger, MediaCentre mc, Element element) {
		...
		if (title == null) {
			logger.log("Invalid play song action in bahaviours: " + path, LogSource.ERROR, LogSource.BEHAVIOUR, 1);
			return;
		}
	}
