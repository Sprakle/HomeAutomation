...
import net.sprakle.homeAutomation.externalSoftware.commandLine.os.LinuxCLI;
import net.sprakle.homeAutomation.externalSoftware.commandLine.os.MacCLI;
import net.sprakle.homeAutomation.externalSoftware.commandLine.os.WindowsCLI;
