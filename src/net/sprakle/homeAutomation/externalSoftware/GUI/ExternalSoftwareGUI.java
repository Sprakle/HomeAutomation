...
public class ExternalSoftwareGUI {
	...
	private final HashMap<SoftwareName, JCheckBox> checkboxes;
    ...
    public ExternalSoftwareGUI(Logger logger, SoftwareName[] software) {
        ...
        String MESSAGE = "You can disable features that will \ncause problems due to dependency \nissues";
	...
	public synchronized HashMap<SoftwareName, Boolean> getActiveSoftware() {
		HashMap<SoftwareName, Boolean> activeSoftware = new HashMap<>();
	...
	class ButtonListener implements ActionListener {
		...
		private final ExternalSoftwareGUI gui;
