...
public class Phrase {
	...
	public Tag getTag(Tag shellTag, int startIndex) {
		ArrayList<Tag> releventTags = new ArrayList<>(tags.subList(startIndex, tags.size()));
	...
	private boolean match(Tag shell, Tag target) {
        ...
        return typeMatched && valueMatched;
	 ...
	 */
	public PhraseOutline matchOutlines(List<PhraseOutline> phraseOutlines) {
		// used to sort outlines by their confidence rating
		TreeMap<Integer, PhraseOutline> matches = new TreeMap<>();
