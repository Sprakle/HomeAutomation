...
public class PhraseOutline {
	...
	private final ArrayList<Tag> mandatoryTags;
	private final ArrayList<Tag> neutralTags;
	...
	public PhraseOutline(String description) {
		this.description = description;

		mandatoryTags = new ArrayList<>();
		neutralTags = new ArrayList<>();
	}
	...
	private int getConfidence(List<Tag> tags) {
		...
		List<Tag> visitedMandatoryTags = new ArrayList<>();
	...
	private TagResult matchTag(List<Tag> allTags, List<Tag> visitedMandatoryTags, Tag previousOutline, Tag previousMatch, Tag tag) {
		...
		List<Tag> pool = new ArrayList<>(mandatoryTags);
		pool.removeAll(visitedMandatoryTags);
		for (Tag outlineTag : pool) {
			boolean match = tagsMatch(outlineTag, tag);
			boolean outlineFollowsPrevious = tagFollowsTag(mandatoryTags, previousOutline, outlineTag);
			boolean tagFollowsPrevious = tagFollowsTag(allTags, previousMatch, tag);
	...
	public ArrayList<Tag> getTags() {
		return new ArrayList<>(mandatoryTags);
	}
