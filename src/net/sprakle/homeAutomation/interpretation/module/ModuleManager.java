...
public class ModuleManager {
	private final HashMap<JCheckBox, InterpretationModule> modules;
	...
	public List<InterpretationModule> submitForClaiming(Phrase phrase) {
		...
		ArrayList<InterpretationModule> enabledModules = new ArrayList<>();
	...
	private ArrayList<InterpretationModule> getClaimers(ArrayList<InterpretationModule> modules, final Phrase phrase) {
		final ArrayList<InterpretationModule> resultingClaimers = new ArrayList<>();

		final ArrayList<ClaimerThread> threads = new ArrayList<>();
